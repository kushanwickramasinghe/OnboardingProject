...
namespace OnboardingProject.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        public SalesController(OSDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Sales>>> GetSales()
        {
            ...
            var saleslist = _context.Sales.Include(c => c.Customer).Include(p=>p.Product).Include(s=>s.Store);
            return await saleslist.ToListAsync();
        }
